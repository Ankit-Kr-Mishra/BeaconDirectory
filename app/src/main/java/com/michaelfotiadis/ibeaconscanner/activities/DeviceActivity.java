...
public class DeviceActivity extends BaseActivity {
    ...
    private void appendIBeaconInfo(final MergeAdapter adapter, final IBeaconManufacturerData iBeaconData) {
        ...
        /*String MSG = "You are currently giving B.Tech. project presentation in front of the panel in department of Electronics Engineering" +
                "IIT (BHU), Varanasi. This information can be changed accordingly for different beacons giving information related to present" +
                " context and location of the beacon";
        Toast.makeText(getApplicationContext(),MSG,Toast.LENGTH_LONG).show();*/
        Intent intent = new Intent(DeviceActivity.this,Main3Activity.class);
